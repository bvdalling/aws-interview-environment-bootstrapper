...
| **Brute force / credential stuffing** | **High**: same as above if successful | **Low to Medium** | CloudFront plus WAF at the ALB can reduce volumetric attacks; this is still a public endpoint; rate limiting is not a substitute for strong auth |
